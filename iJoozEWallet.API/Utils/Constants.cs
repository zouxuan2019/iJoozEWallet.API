namespace iJoozEWallet.API.Utils
{
    public static class Constants
    {
        ...
        public const string DeductUserNotExistsErrMsg = "UserId:({0}) does not exist, cannot deduct credit.";
        ...
        public const string TransactionIdNotExists = "Transaction: {0} does not exist";
    }
}